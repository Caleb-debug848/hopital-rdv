                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td style="text-align: right;">
                            <span style="display: inline-block; padding: 4px 10px; font-size: 10px; font-weight: 700; color: #10b981; background-color: rgba(16, 185, 129, 0.15); border: 1px solid rgba(16, 185, 129, 0.3); border-radius: 6px; text-transform: uppercase;">
        ...
        <tr>
            <td style="padding: 32px;">
                ...
                <p style="margin: 0 0 24px 0; font-size: 13px; line-height: 22px; color: #475569;">
                    Nous vous confirmons l'enregistrement officiel de votre consultation médicale auprès du <strong>{{ str_starts_with($doctorName, 'Dr') ? $doctorName : 'Dr. ' . $doctorName }}</strong>. Vos informations ont été transmises au service concerné.
                </p>
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="padding-bottom: 12px; border-bottom: 1px solid #e2e8f0;">
                                        <span style="font-size: 11px; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.5px;">Référence convocation</span><br>
                                ...
                                <tr>
                                    <td style="padding-top: 12px; padding-bottom: 8px;">
                                        <span style="font-size: 11px; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.5px;">Date de consultation</span><br>
                                        <span style="font-size: 13px; font-weight: 700; color: #0f172a;">{{ $dateFr }}</span>
                                    </td>
                    ...
                    <tr>
                        <td style="padding: 14px 16px;">
                            ...
                            <div style="font-size: 12px; line-height: 18px; color: #15803d;">
                                Veuillez vous présenter au guichet <strong>15 minutes avant l'heure indiquée</strong>. Vous pouvez télécharger et imprimer votre convocation officielle en cliquant sur le lien ci-dessous.
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 24px;">
                    <tr>
                        <td align="center">
                            <a href="{{ route('patient.rendez-vous.attestation', $rdv->id) }}" style="display: inline-block; padding: 13px 28px; background-color: #0f172a; color: #ffffff; text-decoration: none; font-size: 13px; font-weight: 700; border-radius: 10px; letter-spacing: 0.2px;">
                ...
                <p style="margin: 0; font-size: 12px; line-height: 19px; color: #64748b; text-align: center;">
                    En cas de contretemps, vous pouvez modifier ou annuler votre rendez-vous directement depuis votre compte patient en ligne.
                </p>
        ...
        <tr>
            <td style="padding: 24px 32px; background-color: #f8fafc; border-top: 1px solid #e2e8f0; text-align: center;">
                <div style="font-size: 11px; font-weight: 700; color: #0f172a; margin-bottom: 4px;">
                    HÔPITAL RDV — DIRECTION DES CONSULTATIONS MÉDICALES
                </div>
                <div style="font-size: 10.5px; color: #94a3b8; line-height: 16px;">
                    Ce message automatique a été émis conformément à la réglementation sanitaire et à la Loi n°2013-450 sur la protection des données personnelles.<br>
                    Pour toute urgence vitale, contactez sans délai le service d'accueil des urgences.
                </div>
            </td>
        </tr>
